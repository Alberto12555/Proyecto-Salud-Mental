...
$result_respuestas = $conn->query($sql_respuestas);
        ...
        // Si no se proporciona un id válido, redirigir o manejar el error según el flujo de tu aplicación
        header("Location: pagina_de_error.php"); // Redirige a una página de error adecuada
        exit();
    }
